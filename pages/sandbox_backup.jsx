...
const SandBox = () => {
    ...
    <Head>
        ...
        <div className="sandboxPage">
            	<section class="sectionPageintro">
	...
	<section class="pageSection">
		...
		<div class="project">
			...
			<a href="http://blog.ayushsaran.info" target="_blank" class="projectLink">blog.ayushsaran.info</a>
		</div>
		...
		<div class="project">
			...
			<a href="http://devnotes.ayushsaran.info" target="_blank" class="projectLink">devnotes.ayushsaran.info</a>
		</div>
		...
		<div class="project">
			...
			<a href="http://recommendations.ayushsaran.info" target="_blank" class="projectLink">recommendations.ayushsaran.info</a>
		</div>
		{/* <!--/project--> */}
